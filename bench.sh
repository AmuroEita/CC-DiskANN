...
BASE_CMD="./apps/concurrent_bench --data_type float --dist_fn l2 --data_path data/sift/sift_base.fbin --query_file data/sift/sift_query.fbin --gt_file data/sift/sift_query_base_gt100 -R 32 --Lbuild 50 --Ls 50 --alpha 1.2 -L 10 20 30 40 50 100"
